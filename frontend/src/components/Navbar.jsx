  ...
  return (
    ...
    >
      <img
        ...
        alt="My Website"
        className="cursor-pointer hover:opacity-75 h-12  md:h-20  md:w-20"
      />
    </motion.div>
          </div>
      ...
      {isOpen && (
        <div className="fixed top-0 right-0 h-screen bg-black mt-12 p-2 w-64 transition-transform transform translate-x-0 md:hidden">
